...
import { BreadcrumbLink } from "../model/BreadcrumbLink.js";
import { renderBreadcrumbs } from "./components/breadcrumbs.js";

export const renderPage = (page, breadcrumbs?: BreadcrumbLink[]) => {
    ...
    const defaultBreadcrumbs = [{title: "Home", path: "/"}]
            ...
            <head>
             ...
             <body className="gem-c-layout-for-public govuk-template__body">
              ...
              <div className="wrapper govuk-width-container">
                { renderBreadcrumbs(breadcrumbs || defaultBreadcrumbs )}
